...
namespace Weikio.PluginFramework.Context
{
    ...
    public class PluginLoadContextOptions
    {
        ...
        /// </summary>
        public Func<ILogger<PluginLoadContext>> LoggerFactory { get; set; } = Defaults.LoggerFactory;
        ...
        public static class Defaults
        {
            ...
            /// and the plugin use the same version of the assembly, even if they reference different versions.
            /// </summary>
            public static UseHostApplicationAssembliesEnum UseHostApplicationAssemblies { get; set; } = UseHostApplicationAssembliesEnum.Never;
            ...
            /// Sets the function which is used to create the logger for PluginLoadContextOptions
            /// </summary>
            public static Func<ILogger<PluginLoadContext>> LoggerFactory { get; set; } = () => NullLogger<PluginLoadContext>.Instance;
        }
    }
